...
export function ProductModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-[#081710]/95 backdrop-blur-2xl overflow-y-auto">
      <div className="relative w-full max-w-4xl rounded-3xl bg-[#0D2218] border border-[#C9A86A]/40 shadow-2xl overflow-hidden my-auto max-h-[92vh] overflow-y-auto grid grid-cols-1 md:grid-cols-12 text-[#FAF7F2]">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="md:col-span-6 p-6 sm:p-10 bg-gradient-to-b from-[#143023]/60 via-[#0D2218] to-[#081710] flex flex-col items-center justify-between border-b md:border-b-0 md:border-r border-[#C9A86A]/20">
          <div className="w-full flex items-center justify-between text-[9.5px] sm:text-[10px] font-sans tracking-[0.25em] text-[#C9A86A] uppercase">
          ...
          {/* Finish Switcher */}
          <div className="w-full p-1.5 sm:p-2 rounded-full bg-[#081710]/80 border border-[#C9A86A]/30 flex items-center justify-around">
            <button
              onClick={() => setSelectedFinish("yellow")}
              className={`text-[10px] sm:text-[11px] font-sans tracking-wider uppercase px-2.5 sm:px-3 py-1 rounded-full transition-all ${
        ...
        {/* Right Piece Details */}
        <div className="md:col-span-6 p-6 sm:p-8 md:p-10 flex flex-col justify-between space-y-5 sm:space-y-6">
          <div className="space-y-4">
            <div>
              ...
              <p className="text-lg sm:text-xl font-serif text-[#EBD49B] mt-1">
          ...
          <div className="pt-2 sm:pt-4">
            <button
              ...
              className="w-full py-3.5 sm:py-4 rounded-full bg-gold-metallic text-[#0D2218] text-xs font-sans font-semibold tracking-[0.25em] uppercase hover:shadow-[0_0_25px_rgba(201,168,106,0.6)] transition-all flex items-center justify-center gap-2"
            >
