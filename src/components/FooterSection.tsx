...
export function FooterSection() {
  ...
  return (
    <footer className="bg-[#081710] text-[#FAF7F2] pt-16 sm:pt-24 pb-10 sm:pb-12 px-4 sm:px-8 md:px-12 border-t border-[#C9A86A]/25 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto space-y-16 sm:space-y-20 relative z-10">
        ...
        <div className="p-6 sm:p-10 md:p-12 rounded-3xl bg-[#0D2218] border border-[#C9A86A]/30 shadow-2xl grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
          <div className="lg:col-span-7 space-y-2.5 sm:space-y-3">
            <span className="text-[9.5px] sm:text-[10px] font-sans tracking-[0.3em] sm:tracking-[0.35em] text-[#C9A86A] uppercase font-medium">
          ...
          <div className="lg:col-span-5">
            {!subscribed ? (
              <form onSubmit={handleSubscribe} className="space-y-2.5 sm:space-y-3">
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-4 sm:pl-5 pr-28 sm:pr-32 py-3.5 sm:py-4 rounded-full bg-[#081710] border border-[#C9A86A]/40 text-xs sm:text-sm font-sans text-[#FAF7F2] placeholder-[#FAF7F2]/40 focus:outline-none focus:border-[#C9A86A]"
                  />
                  <button
                    type="submit"
                    className="absolute right-1.5 top-1.5 bottom-1.5 px-4 sm:px-5 rounded-full bg-gold-metallic text-[#0D2218] text-[10.5px] sm:text-[11px] font-sans font-semibold tracking-wider uppercase hover:opacity-90 transition-opacity flex items-center gap-1.5"
                  >
                    <span>Join</span>
                    <ArrowRight className="w-3 h-3" />
                  </button>
                </div>
                <span className="text-[9.5px] sm:text-[10px] font-sans text-[#FAF7F2]/50 tracking-wider block pl-3 sm:pl-4">
              ...
              <div className="flex items-center gap-3 p-4 rounded-2xl bg-[#163326] border border-[#C9A86A]/40 text-xs font-sans text-[#EBD49B]">
                <Check className="w-5 h-5 text-[#C9A86A] flex-shrink-0" />
        ...
        {/* Live Atelier Clocks */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 p-4 sm:p-6 rounded-2xl bg-[#0D2218]/50 border border-[#C9A86A]/15">
          ...
          <div className="flex items-center justify-between px-2 sm:px-4 border-t sm:border-t-0 sm:border-l border-[#C9A86A]/15 pt-3 sm:pt-0">
            <div className="flex items-center gap-2 text-xs font-sans tracking-widest text-[#FAF7F2]/70 uppercase">
              <Globe className="w-3.5 h-3.5 text-[#C9A86A]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 sm:gap-12 pt-6 sm:pt-8 border-t border-[#C9A86A]/15">
          {/* Brand Col */}
          <div className="md:col-span-5 space-y-3.5 sm:space-y-4">
            <div className="flex items-center gap-3">
              <img
                ...
                alt="RÍÌTÀN Emblem"
                className="w-10 h-10 sm:w-11 sm:h-11 object-contain filter drop-shadow-[0_2px_10px_rgba(201,168,106,0.3)]"
                onError={(e) => {
                  (e.target as HTMLElement).style.display = 'none';
                }}
              />
              <div>
                <span className="font-serif text-2xl sm:text-3xl tracking-[0.28em] sm:tracking-[0.35em] text-[#FAF7F2] uppercase font-light block">
                  R Í Ì T À N
                </span>
                <span className="text-[9px] sm:text-[10px] tracking-[0.35em] sm:tracking-[0.4em] text-[#C9A86A] uppercase font-sans block">
          ...
          <div className="md:col-span-4 space-y-2.5 sm:space-y-3">
            ...
            <div className="space-y-2 text-xs font-sans text-[#FAF7F2]/75">
              ...
              <div className="pt-1.5 text-[11px] text-[#C9A86A]">
        ...
        {/* Legal Bottom Bar */}
        <div className="pt-6 sm:pt-8 border-t border-[#C9A86A]/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-[9.5px] sm:text-[10px] font-sans text-[#FAF7F2]/50 tracking-wider text-center sm:text-left">
          <div>
